...
def run_experiment(EXP_EPOCHS=10, EXP_LR=0.001):
    ...
    def train_model(model, criterion, optimizer, scheduler, num_epochs):
        ...
        # save plot and data
        filename = f'exp3_cnn_epoch{EXP_EPOCHS}_lr{EXP_LR}'
...
EXP_EPOCHS = 25
EXP_LRS = [0.0001, 0.001]
# EXP_LRS = [0.0005, 0.002, 0.005]

for EXP_LR in EXP_LRS:
    run_experiment(EXP_EPOCHS=EXP_EPOCHS, EXP_LR=EXP_LR)
    # exit()
